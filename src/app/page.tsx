          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-24">
            ...
            <div className="flex flex-col justify-start space-y-8 pt-8">
              ...
              >
                ...
                <span className="font-mono text-black">nextlayerstudio</span>
              </a>
              ...
              >
                ...
                <span className="font-mono text-black">NextLayer-Studio</span>
              </a>
              ...
              >
                ...
                <span className="font-mono text-black">+421 902 238 309</span>
              </a>
              ...
              >
                ...
                <span className="font-mono text-black">team@nextlayer.studio</span>
              </a>
            </div>
          </div>
        </section>
