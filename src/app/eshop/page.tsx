        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          ...
          <AnimatedOnScroll animation="fade-up" delay={0} className="h-full">
            <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8 flex flex-col items-start h-full transition-transform duration-200 hover:scale-105">
              ...
              <div className="flex-grow">
                <div className="font-heading text-lg md:text-2xl font-bold mb-2 text-[#023047]">{t('eshop.fashionEshop')}</div>
                <div className="font-mono text-xs md:text-sm text-[#FFB703] mb-2">{t('eshop.fashionCategory')}</div>
                <div className="font-mono text-sm md:text-base mb-3 text-black">
                  {t('eshop.fashionDesc')}
                </div>
                <div className="flex flex-wrap gap-3 mb-6">
                  <div className="px-3 py-1 bg-[#8ECAE6]/20 rounded-full">
                    <span className="font-mono text-xs text-[#023047]">{t('eshop.salesGrowth')}</span>
                  </div>
                  <div className="px-3 py-1 bg-[#8ECAE6]/20 rounded-full">
                    <span className="font-mono text-xs text-[#023047]">{t('eshop.customers5k')}</span>
                  </div>
                </div>
              </div>
          ...
          <AnimatedOnScroll animation="fade-up" delay={100} className="h-full">
            <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8 flex flex-col items-start h-full transition-transform duration-200 hover:scale-105">
              ...
              <div className="flex-grow">
                <div className="font-heading text-lg md:text-2xl font-bold mb-2 text-[#023047]">{t('eshop.electronicsEshop')}</div>
                <div className="font-mono text-xs md:text-sm text-[#FFB703] mb-2">{t('eshop.electronicsCategory')}</div>
                <div className="font-mono text-sm md:text-base mb-3 text-black">
                  {t('eshop.electronicsDesc')}
                </div>
                <div className="flex flex-wrap gap-3 mb-6">
                  <div className="px-3 py-1 bg-[#8ECAE6]/20 rounded-full">
                    <span className="font-mono text-xs text-[#023047]">{t('eshop.salesGrowth200')}</span>
                  </div>
                  <div className="px-3 py-1 bg-[#8ECAE6]/20 rounded-full">
                    <span className="font-mono text-xs text-[#023047]">{t('eshop.customers8k')}</span>
                  </div>
                </div>
              </div>
