...
export const metadata: Metadata = {
  title: "NextLayer Studio - Tvorba Eshopu",
  description: "Vytvorenie e-shopu - Vaša cesta k úspešnému online predaju s NextLayer Studio",
};

// Static Navbar component for eshop page
...
// Static Footer component for eshop page
