        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <AnimatedOnScroll animation="fade-right">
            <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
              <h2 className="font-heading text-3xl md:text-4xl font-bold mb-6 text-[#023047]">{t('contact.whereToFindUs')}</h2>
              
              {/* Phone */}
              <div className="mb-8">
                <div className="font-heading text-xl font-bold mb-2 text-[#023047]">{t('contact.phone')}</div>
                <div className="flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" viewBox="0 0 20 20" fill="currentColor">
                    <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                  </svg>
                  <a href="tel:0903652258" className="font-mono text-lg hover:text-[#219EBC] transition-colors">
                    0903 652 258
                  </a>
                </div>
              </div>
              ...
              {/* Email */}
              <div className="mb-8">
                <div className="font-heading text-xl font-bold mb-2 text-[#023047]">{t('contact.email')}</div>
                <div className="flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" viewBox="0 0 20 20" fill="currentColor">
                    <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" />
                    <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" />
                  </svg>
                  <a href="mailto:nextlayerstudio@gmail.com" className="font-mono text-lg hover:text-[#219EBC] transition-colors">
              ...
              {/* Social Media */}
              <div>
                <div className="font-heading text-xl font-bold mb-4 text-[#023047]">{t('contact.socialMedia')}</div>
          ...
          <AnimatedOnScroll animation="fade-left">
            <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
              <h2 className="font-heading text-3xl md:text-4xl font-bold mb-8 text-[#023047]">{t('contact.contactForm')}</h2>
