...
export const metadata: Metadata = {
  title: "NextLayer Studio - O nás",
  description: "Sme tím, ktorý tvorí vrstvu navyše. Spoznajte náš tím a našu prácu.",
};

// Static Navbar component for o-nas page
...
// Static Footer component for o-nas page
