    ...
    <main className="p-4 sm:p-8 relative z-10" style={{ background: '#8ECAE6' }}>
      ...
      <section className="max-w-7xl mx-auto mb-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          {/* Static Contact Form (non-functional) */}
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
            <h2 className="font-heading text-3xl md:text-4xl font-bold mb-8 text-[#023047]">Kontaktný formulár</h2>
            
            <form action="https://formspree.io/f/xwkglzea" method="POST" className="space-y-6">
              {/* Name Field */}
              <div>
                <input
                  type="text"
              ...
              <div>
                <button 
                  type="submit" 
                  className="font-mono px-4 py-2 sm:px-5 sm:py-3 rounded-[16px] text-base sm:text-lg font-bold bg-[#FFB703] border-2 border-[#FFB703] text-[#023047] hover:bg-[#023047] hover:text-white transition-colors w-full"
                >
                  Odoslať správu
                </button>
              </div>
